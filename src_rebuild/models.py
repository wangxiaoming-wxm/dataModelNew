...
def candidate_configs(profile: str) -> tuple[ModelConfig, ...]:
    ...
    return (
        ...
        ModelConfig(
            name="cb_ratio_freq_rmse_d5",
            feature_mode="ratio_freq",
            objective="rmse",
            depth=5,
            iterations=rmse_iterations,
            learning_rate=0.03,
        ...
        ModelConfig(
            name="cb_rate_freq_rmse_d6",
            feature_mode="rate_freq",
            objective="rmse",
            depth=6,
            iterations=rmse_iterations,
            learning_rate=0.03,
