...
TRAIN = "数据建模/train.csv"; TEST = "数据建模/test.csv"
LOG_PATH = os.path.join(HERE, "explore_best.log")
...
if __name__ == "__main__":
    ...
    np.save("best_oof.npy", {"main":o1,"alt":o2,"fuse":fuse_oof})
    np.save("best_test.npy", {"main":t1,"alt":t2,"fuse":fuse_te})
    log.info(f"已保存 submission_best.csv")
